namespace BlogSystem.Models.Migrations
{
    ...
    public partial class createBlog : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PortraitPath = c.String(nullable: false, maxLength: 300, unicode: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Articles", "BlogCategory_Id", "dbo.BlogCategories");
            ...
            DropIndex("dbo.Articles", new[] { "BlogCategory_Id" });
